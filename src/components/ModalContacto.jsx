        ...
        <Modal show={show} onHide={handleClose} className='text-black' aria-labelledby="contained-modal-title-vcenter ">
            ...
            <Modal.Body className="grid-example">
                <Container>
                    <Row>
                        <Col xs={12} md={12}>
                            <div className='shadow border' style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
                                <iframe
                        ...
                        <Col xs={6} md={12}>
                            <p className='mt-4'><i className="bi bi-geo-alt-fill text-danger"></i> RP N°2 - Km 22.5 - Los Morados, San Antonio, Jujuy</p>
                        </Col>
                        <Col xs={6} md={12}>
                            <p className=''><i className="bi bi-telephone-plus-fill text-success"></i> Tel.: 0388 573-9885</p>
                        </Col>
                        <Col xs={6} md={12}>
